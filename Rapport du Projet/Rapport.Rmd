...
Dans cette section on va analyser comment la force du vent est influence par zone geoegraphique sur les incendies 
...
3.  Pour le troisième groupe, nous avons utilisé **(2 * quart + 1) : (3 fois le quart) donc ce groupe inclura les lignes de 2*quart+1 jusqu'à 3*quart.
