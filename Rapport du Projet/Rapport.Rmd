...
*****
De plus on voudrais indiquer que durant le travail sur notre projet sur les deux parties Informatique et Statistique on avait travailler sur GitHub une plateforme collaborative qui permet qui nous permet de travailler en groupe sur un code ensemble en définissant les etapes de chaque membre du groupe. Enfin cette plateforme nous permet en plus de mixer le code complet en un seul fichier et pas besoin de rassembler les codes ensembles.
