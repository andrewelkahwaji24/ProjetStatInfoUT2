...
Le premier document, relatif aux incendies, est probablement le plus vital pour l'analyse de ce phénomène.  

Il renferme une série de caractéristiques précisant le contexte de chaque feu.  
...
ggplot(surv_data, aes(x = time, y = surv)) +
  geom_step(aes(color = "blue"), size = 1.5) +  
  labs(
  ...
  theme(
    ...
    axis.text = element_text(size = 12),  
    axis.text.x = element_text(angle = 45, hjust = 1),  
    plot.caption = element_text(hjust = 1, size = 10, color = "grey"),  
